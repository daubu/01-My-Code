...
function insertList(){
	...
	if(jQuery('#list_type').val() == 'ordered_list'){
		list_shcode = '[ordered_list style="'+jQuery('#ordered_list').val()+'"] <ol> <li>'+__('Here goes the list item')+'</li> </ol>	[/ordered_list]';
	}
	else{
		list_shcode = '[unordered_list style="'+jQuery('#unordered_list').val()+'"] <ul> <li>'+__('Here goes the list item')+'</li> </ul>	[/unordered_list]'; 
	}
