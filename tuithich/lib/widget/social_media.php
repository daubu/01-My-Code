...
?>
			<div class="social-media <?php echo $icons_style; ?>">
				<ul>
					...
					<li class="flickr"><a href="http://www.flickr.com/groups/<?php echo $flickr_id; ?>/" class="hover" >Flickr</a> </li>
					<?php } ?>
                    <?php if(isset($linkedin_url) && strlen($linkedin_url ) ) {?>
					<li class="linked"><a href="<?php echo $linkedin_url; ?>" class="hover" >blog.tuithich.vn</a> </li>
					<?php } ?>
