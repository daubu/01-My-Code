<?php
    class post{
			...
			?>
                <article <?php post_class( 'item ' . $classes ); ?>>
                    ...
                    <?php if( $thumbnail ) : ?>            
                            ...
                            <a class="stripes" href="<?php echo get_permalink( $post -> ID ) ?>"></a>
                            ...
                            <div class="meta-user">
                                ...
                                <ul class="likes-comments">
                                    ...
                                    <?php if ( comments_open( $post -> ID ) ) : ?>
                                        ...
                                        <li class="cosmo-comments <?php echo $classes; ?>">
        ...
        public static function my_likes(){
			...
			$wp_query = new WP_Query( array( 'post_type' => $resources[$customID]['slug'] , 'post_status' => 'publish' , 'posts_per_page' => -1 , 'orderby' => 'ID' ) );
			$break = false;
